...
GridWithWeights make_diagram4() {
    GridWithWeights grid(16, 16);
    add_rect(grid, 8,10, 11, 11);
    add_rect(grid, 4,4, 8, 5);
    add_rect(grid, 5,5, 6,16 );
    add_rect(grid, 10,0, 11, 11);
     add_rect(grid, 13,1, 14, 16);
...
int main() {
    ...
    Location<double> last = Location<double>(4.4,6.6);
    Location<double> second = Location<double>(1,1);
    
    cout <<last.x() <<"LLLL"<<last.y() <<endl;
    
    last=last*2;
    
    cout <<last.x() <<"LLL"<<last.y() <<endl;
...
//    SquareGrid::Location start{0, 0};
//    SquareGrid::Location goal{15, 15};
